...
<div class="form-container">
    ...
    <form:form method="POST" action="/reg" modelAttribute="student" class="form-horizontal">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7" class="form-control input-sm" id="sex">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-1">
                    <form:checkbox path="firstAttempt" id="firstAttempt" class="form-control input-sm"/>
                    <div class="has-error">
